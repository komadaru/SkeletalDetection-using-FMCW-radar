...
def process_and_save_upper(file_path, angle, height, depth):
    with open(file_path, "r", encoding="utf-8") as json_file:
        data = json.load(json_file)
...
input_folder = "C:/Users/kodam/PycharmProjects/mmModels/DataMake/RawData/mmData1223_rm/TwoRadars_notilt/lower/"
output_folder = "C:/Users/kodam/PycharmProjects/mmModels/DataMake/RawData/mmData1223_rm/TwoRadars_notilt/lower_fixed/"
...
input_folder = "C:/Users/kodam/PycharmProjects/mmModels/DataMake/RawData/mmData1223_rm/TwoRadars_notilt/upper/"
output_folder = "C:/Users/kodam/PycharmProjects/mmModels/DataMake/RawData/mmData1223_rm/TwoRadars_notilt/upper_fixed/"
...
for filename in sorted(os.listdir(input_folder)):
    if filename.endswith(".json"):
        file_path = os.path.join(input_folder, filename)
        print(file_path)
        process_and_save_upper(file_path, angle_upper, height_upper, depth_upper)