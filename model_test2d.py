...
# 学習済みモデルの読み込み
model = PointNetmmPoseLinear(num_points, num_labels).cuda()
model.load_state_dict(torch.load("C:/Users/kodam/PycharmProjects/mmModels/Models/TwoRadars_tilt_mmPosexy_MLP22/saved_model_36.pth"))
